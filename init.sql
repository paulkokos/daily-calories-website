...
create user if not exists 'daily_calories_website_production_user'@localhost identified by 'testpassword';
GRANT ALL PRIVILEGES ON daily_calories_website_production TO 'daily_calories_website_production_user'@localhost;


create schema if not exists daily_calories_website_development;
use daily_calories_website_development;
create user if not exists 'daily_calories_website_development_user'@localhost identified by 'testpassword';
GRANT ALL PRIVILEGES ON daily_calories_website_development TO 'daily_calories_website_development_user'@localhost;
...
drop user if exists daily_calories_website_production_user@localhost;
drop user if exists daily_calories_website_development_user@localhost;